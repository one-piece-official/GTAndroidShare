...
public class HttpHeaderParser {
    ...
    public static boolean isSupportRange(Map<String, String> headers) {

        if (TextUtils.equals(getHeader(headers, "Accept-Ranges"), "bytes")) {
            return true;
        }
        String value = getHeader(headers, "Content-Range");
        return value != null && value.startsWith("bytes");
    }

    public static boolean isGzipContent(Map<String, String> headers) {
