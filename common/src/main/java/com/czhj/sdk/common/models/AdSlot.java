...
public final class AdSlot extends AndroidMessage<AdSlot, AdSlot.Builder> {
  ...
  public AdSlot(String adslot_id, Size adslot_size, List<Integer> adslot_type, Integer bidfloor,
      String vid, String latest_camp_id, String latest_crid, List<Integer> material_type,
      Integer sdk_strategy_index, Integer api_strategy_index, Map<String, String> sdk_cached_ads,
      List<Integer> creative_type, Integer algorithm_floor, Map<String, String> ext,
      Map<String, AdCache> ad_caches, Video video, Integer expected_floor, Integer settlement_mode,
      Integer alg_bid_type, Integer ecpm_target, Integer settlement_setting, Integer commer_ecpm,
      Integer adx_ecpm, Integer commer_ecpm_state, Integer ad_count,
      List<Integer> support_template_id, Boolean disable_mraid2, Integer media_request_count,
      Integer media_ready_count, Long pre_req_time, Integer req_interval_time,
      Integer cached_ad_size) {
  ...
  public AdSlot(String adslot_id, Size adslot_size, List<Integer> adslot_type, Integer bidfloor,
      ...
      List<Integer> support_template_id, Boolean disable_mraid2, Integer media_request_count,
      Integer media_ready_count, Long pre_req_time, Integer req_interval_time,
      Integer cached_ad_size, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    return unknownFields().equals(o.unknownFields())
        ...
        && Internal.equals(adslot_size, o.adslot_size)
        && adslot_type.equals(o.adslot_type)
        && Internal.equals(bidfloor, o.bidfloor)
        && Internal.equals(vid, o.vid)
        && Internal.equals(latest_camp_id, o.latest_camp_id)
        && Internal.equals(latest_crid, o.latest_crid)
        && material_type.equals(o.material_type)
        && Internal.equals(sdk_strategy_index, o.sdk_strategy_index)
        && Internal.equals(api_strategy_index, o.api_strategy_index)
        && sdk_cached_ads.equals(o.sdk_cached_ads)
        && creative_type.equals(o.creative_type)
        && Internal.equals(algorithm_floor, o.algorithm_floor)
        && ext.equals(o.ext)
        && ad_caches.equals(o.ad_caches)
        && Internal.equals(video, o.video)
        && Internal.equals(expected_floor, o.expected_floor)
        && Internal.equals(settlement_mode, o.settlement_mode)
        && Internal.equals(alg_bid_type, o.alg_bid_type)
        && Internal.equals(ecpm_target, o.ecpm_target)
        && Internal.equals(settlement_setting, o.settlement_setting)
        && Internal.equals(commer_ecpm, o.commer_ecpm)
        && Internal.equals(adx_ecpm, o.adx_ecpm)
        && Internal.equals(commer_ecpm_state, o.commer_ecpm_state)
        && Internal.equals(ad_count, o.ad_count)
        && support_template_id.equals(o.support_template_id)
        && Internal.equals(disable_mraid2, o.disable_mraid2)
        && Internal.equals(media_request_count, o.media_request_count)
        && Internal.equals(media_ready_count, o.media_ready_count)
        && Internal.equals(pre_req_time, o.pre_req_time)
        && Internal.equals(req_interval_time, o.req_interval_time)
        && Internal.equals(cached_ad_size, o.cached_ad_size);
  }
  ...
  public String toString() {
    ...
    if (sdk_strategy_index != null) builder.append(", sdk_strategy_index=").append(sdk_strategy_index);
    if (api_strategy_index != null) builder.append(", api_strategy_index=").append(api_strategy_index);
    ...
    if (settlement_setting != null) builder.append(", settlement_setting=").append(settlement_setting);
    ...
    if (commer_ecpm_state != null) builder.append(", commer_ecpm_state=").append(commer_ecpm_state);
    if (ad_count != null) builder.append(", ad_count=").append(ad_count);
    if (!support_template_id.isEmpty()) builder.append(", support_template_id=").append(support_template_id);
    if (disable_mraid2 != null) builder.append(", disable_mraid2=").append(disable_mraid2);
    if (media_request_count != null) builder.append(", media_request_count=").append(media_request_count);
    if (media_ready_count != null) builder.append(", media_ready_count=").append(media_ready_count);
  ...
  private static final class ProtoAdapter_AdSlot extends ProtoAdapter<AdSlot> {
    ...
    public int encodedSize(AdSlot value) {
      return ProtoAdapter.STRING.encodedSizeWithTag(1, value.adslot_id)
          + Size.ADAPTER.encodedSizeWithTag(2, value.adslot_size)
          + ProtoAdapter.UINT32.asRepeated().encodedSizeWithTag(3, value.adslot_type)
          + ProtoAdapter.UINT32.encodedSizeWithTag(4, value.bidfloor)
          + ProtoAdapter.STRING.encodedSizeWithTag(5, value.vid)
          + ProtoAdapter.STRING.encodedSizeWithTag(6, value.latest_camp_id)
          + ProtoAdapter.STRING.encodedSizeWithTag(7, value.latest_crid)
          + ProtoAdapter.UINT32.asRepeated().encodedSizeWithTag(8, value.material_type)
          + ProtoAdapter.UINT32.encodedSizeWithTag(9, value.sdk_strategy_index)
          + ProtoAdapter.UINT32.encodedSizeWithTag(10, value.api_strategy_index)
          + sdk_cached_ads.encodedSizeWithTag(11, value.sdk_cached_ads)
          + ProtoAdapter.UINT32.asRepeated().encodedSizeWithTag(12, value.creative_type)
          + ProtoAdapter.UINT32.encodedSizeWithTag(13, value.algorithm_floor)
          + ext.encodedSizeWithTag(14, value.ext)
          + ad_caches.encodedSizeWithTag(15, value.ad_caches)
          + Video.ADAPTER.encodedSizeWithTag(16, value.video)
          + ProtoAdapter.UINT32.encodedSizeWithTag(17, value.expected_floor)
          + ProtoAdapter.UINT32.encodedSizeWithTag(19, value.settlement_mode)
          + ProtoAdapter.UINT32.encodedSizeWithTag(20, value.alg_bid_type)
          + ProtoAdapter.UINT32.encodedSizeWithTag(21, value.ecpm_target)
          + ProtoAdapter.UINT32.encodedSizeWithTag(22, value.settlement_setting)
          + ProtoAdapter.UINT32.encodedSizeWithTag(23, value.commer_ecpm)
          + ProtoAdapter.UINT32.encodedSizeWithTag(24, value.adx_ecpm)
          + ProtoAdapter.UINT32.encodedSizeWithTag(25, value.commer_ecpm_state)
          + ProtoAdapter.UINT32.encodedSizeWithTag(28, value.ad_count)
          + ProtoAdapter.UINT32.asRepeated().encodedSizeWithTag(46, value.support_template_id)
          + ProtoAdapter.BOOL.encodedSizeWithTag(48, value.disable_mraid2)
          + ProtoAdapter.UINT32.encodedSizeWithTag(52, value.media_request_count)
          + ProtoAdapter.UINT32.encodedSizeWithTag(53, value.media_ready_count)
          + ProtoAdapter.INT64.encodedSizeWithTag(54, value.pre_req_time)
          + ProtoAdapter.INT32.encodedSizeWithTag(55, value.req_interval_time)
          + ProtoAdapter.UINT32.encodedSizeWithTag(56, value.cached_ad_size)
    ...
    public AdSlot decode(ProtoReader reader) throws IOException {
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          ...
          case 2: builder.adslot_size(Size.ADAPTER.decode(reader)); break;
          case 3: builder.adslot_type.add(ProtoAdapter.UINT32.decode(reader)); break;
          case 4: builder.bidfloor(ProtoAdapter.UINT32.decode(reader)); break;
          case 5: builder.vid(ProtoAdapter.STRING.decode(reader)); break;
          case 6: builder.latest_camp_id(ProtoAdapter.STRING.decode(reader)); break;
          case 7: builder.latest_crid(ProtoAdapter.STRING.decode(reader)); break;
          case 8: builder.material_type.add(ProtoAdapter.UINT32.decode(reader)); break;
          case 9: builder.sdk_strategy_index(ProtoAdapter.UINT32.decode(reader)); break;
          case 10: builder.api_strategy_index(ProtoAdapter.UINT32.decode(reader)); break;
          case 11: builder.sdk_cached_ads.putAll(sdk_cached_ads.decode(reader)); break;
          case 12: builder.creative_type.add(ProtoAdapter.UINT32.decode(reader)); break;
          case 13: builder.algorithm_floor(ProtoAdapter.UINT32.decode(reader)); break;
          case 14: builder.ext.putAll(ext.decode(reader)); break;
          case 15: builder.ad_caches.putAll(ad_caches.decode(reader)); break;
          case 16: builder.video(Video.ADAPTER.decode(reader)); break;
          case 17: builder.expected_floor(ProtoAdapter.UINT32.decode(reader)); break;
          case 19: builder.settlement_mode(ProtoAdapter.UINT32.decode(reader)); break;
          case 20: builder.alg_bid_type(ProtoAdapter.UINT32.decode(reader)); break;
          case 21: builder.ecpm_target(ProtoAdapter.UINT32.decode(reader)); break;
          case 22: builder.settlement_setting(ProtoAdapter.UINT32.decode(reader)); break;
          case 23: builder.commer_ecpm(ProtoAdapter.UINT32.decode(reader)); break;
          case 24: builder.adx_ecpm(ProtoAdapter.UINT32.decode(reader)); break;
          case 25: builder.commer_ecpm_state(ProtoAdapter.UINT32.decode(reader)); break;
          case 28: builder.ad_count(ProtoAdapter.UINT32.decode(reader)); break;
          case 46: builder.support_template_id.add(ProtoAdapter.UINT32.decode(reader)); break;
          case 48: builder.disable_mraid2(ProtoAdapter.BOOL.decode(reader)); break;
          case 52: builder.media_request_count(ProtoAdapter.UINT32.decode(reader)); break;
          case 53: builder.media_ready_count(ProtoAdapter.UINT32.decode(reader)); break;
          case 54: builder.pre_req_time(ProtoAdapter.INT64.decode(reader)); break;
          case 55: builder.req_interval_time(ProtoAdapter.INT32.decode(reader)); break;
          case 56: builder.cached_ad_size(ProtoAdapter.UINT32.decode(reader)); break;
          default: {
    ...
    public AdSlot redact(AdSlot value) {
      ...
      if (builder.adslot_size != null) builder.adslot_size = Size.ADAPTER.redact(builder.adslot_size);
