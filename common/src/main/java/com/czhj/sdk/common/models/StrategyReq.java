...
public final class StrategyReq extends AndroidMessage<StrategyReq, StrategyReq.Builder> {
    ...
    public boolean equals(Object other) {
        ...
        return unknownFields().equals(o.unknownFields()) && Internal.equals(strategy_init, o.strategy_init) && Internal.equals(last_strategy_id, o.last_strategy_id);
    }
    ...
    public String toString() {
        ...
        if (last_strategy_id != null)
            builder.append(", last_strategy_id=").append(last_strategy_id);
    ...
    private static final class ProtoAdapter_StrategyReq extends ProtoAdapter<StrategyReq> {
        ...
        public int encodedSize(StrategyReq value) {
            return ProtoAdapter.BOOL.encodedSizeWithTag(1, value.strategy_init) + ProtoAdapter.STRING.encodedSizeWithTag(2, value.last_strategy_id) + value.unknownFields().size();
        }
        ...
        public StrategyReq decode(ProtoReader reader) throws IOException {
            ...
            for (int tag; (tag = reader.nextTag()) != -1; ) {
                switch (tag) {
                    case 1:
                        builder.strategy_init(ProtoAdapter.BOOL.decode(reader));
                        break;
                    case 2:
                        builder.last_strategy_id(ProtoAdapter.STRING.decode(reader));
                        break;
                    default: {
