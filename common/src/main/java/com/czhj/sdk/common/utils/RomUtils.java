...
public final class RomUtils {
    ...
    private static final String[] ROM_HUAWEI = {"EMUI", "huawei"};
    private static final String[] ROM_VIVO = {"FuntouchOS", "vivo"};
    private static final String[] ROM_XIAOMI = {"MIUI", "xiaomi"};
    private static final String[] ROM_OPPO = {"ColorOS", "oppo"};
    private static final String[] ROM_LEECO = {"EUI", "letv"};
    private static final String[] ROM_360 = {"360", "qiku"};
    private static final String[] ROM_ZTE = {"zte"};
    private static final String[] ROM_ONEPLUS = {"oneplus"};
    private static final String[] ROM_NUBIA = {"NubiaUI", "nubia"};
    ...
    private static final String[] ROM_MEIZU = {"Flyme", "meizu"};
    private static final String[] ROM_LENOVO = {"lenovo"};
    private static final String[] ROM_SMARTISAN = {"SmartisanOS", "deltainno"};
    private static final String[] ROM_HTC = {"Sense", "htc"};
    private static final String[] ROM_SONY = {"sony"};
    private static final String[] ROM_GIONEE = {"amigo", "gionee"};
    ...
    public static boolean isHuawei() {
        return ROM_HUAWEI[0].equals(getRomInfo().name) || isHarmonyOs();
    }
    ...
    public static RomInfo getRomInfo() {
        ...
        if (isHarmonyOs()) {
            ...
            bean.osMarket = "com.huawei.appmarket";
        ...
        if (isRightRom(brand, manufacturer, ROM_VIVO)) {
            ...
            bean.osMarket = "com.bbk.appstore";
        ...
        if (isRightRom(brand, manufacturer, ROM_XIAOMI)) {
            ...
            bean.osMarket = "com.xiaomi.market";

            return bean;
        }
        if (isRightRom(brand, manufacturer, ROM_OPPO)) {
            bean.name = ROM_OPPO[0];
            for (String value : VERSION_PROPERTY_OPPO) {
                String versionName = getRomVersion(value);
                if (TextUtils.isEmpty(value)) {
                    continue;
                }
                bean.version = versionName;

            }

            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.Q) {
                bean.osMarket = "com.oppo.market";
            } else {
                bean.osMarket = "com.heytap.market";
            }
        ...
        if (isRightRom(brand, manufacturer, ROM_NUBIA)) {
            ...
            bean.osMarket = "cn.nubia.neostore";
            return bean;
        }
        ...
        if (isRightRom(brand, manufacturer, ROM_COOLPAD)) {
            ...
            bean.osMarket = "com.meizu.mstore";
            ...
            bean.osMarket = "com.smartisanos.appstore";
